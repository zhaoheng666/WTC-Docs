...
54  OldVegasCasino.debug.dylib    	       0x102e555dc std::__1::__function::__alloc_func<void cocos2d::Scheduler::scheduleUpdate<JSScheduleWrapper>(JSScheduleWrapper*, int, bool)::'lambda'(float), std::__1::allocator<void cocos2d::Scheduler::scheduleUpdate<JSScheduleWrapper>(JSScheduleWrapper*, int, bool)::'lambda'(float)>, void (float)>::operator()[abi:de180100](/../故障排查/float&&) + 36
...
56  OldVegasCasino.debug.dylib    	       0x10253cea4 std::__1::__function::__value_func<void (float)>::operator()[abi:de180100](/../故障排查/float&&) const + 76
...
![image](/assets/beea574b7030a0ccf7e6e52732ee91c0.png)
...
- 3、fixedPriority == 0：（根据地址偏移量初步推算，最有可能是这个断言）
  ...
  ![image](/assets/6defe05dd7ccbfd5318a41117a5b927c.png)
