...
1. ##### 刷新标记：
    ...
    ![image](assets/image-20250522122548-blk434b.png)​
2. ##### 增加标记：绿色标记代表“不压缩”

    1. 可针对目录、或文件;
    2. 聚焦回 cocosbuilder（点击 cocosbuilder 任意区域），查看标记状态；

    ![image](assets/image-20250522121750-32cw8g4.png)![image](assets/image-20250522121926-2rcykfl.png)​
...
3. ##### 移除标记：
    ...
    ![image](assets/image-20250522123719-xwfuvfy.png)![image](assets/image-20250522123927-oqmhug2.png)​
